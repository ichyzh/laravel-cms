      ...
      <div class="row">
        ...
        <div class="col-md-8 col-xl-9">
          <div class="row gap-y">
            ...
            @empty
              <p class="text-center">No results for query: <strong>{{ request()->query('q') }}</strong></p>
            @endforelse
        ...
        <div class="col-md-4 col-xl-3">
          <div class="sidebar px-4 py-md-0">
            ...
            <form class="input-group" action="{{ route('welcome') }}" method="GET">
              <input type="text" class="form-control" name="q" placeholder="Search" value="{{ request()->query('q') }}">
